...
.tag-select {
  ...
  &__trigger {
    ...
    padding: 0 12px;
    border-radius: 12px;
    border: 1px solid rgba(240, 138, 107, 0.22);
    background: rgba(255, 255, 255, 0.82);
    box-shadow: 0 4px 12px rgba(176, 74, 54, 0.06);
    color: #5c2e24;
    cursor: pointer;
  ...
  &.open &__trigger {
    border-color: rgba(240, 138, 107, 0.55);
    box-shadow: 0 0 0 3px rgba(255, 180, 162, 0.35);
  }
  ...
  &__chevron {
    ...
    height: 8px;
    flex-shrink: 0;
    border-right: 2px solid #a86b5c;
    border-bottom: 2px solid #a86b5c;
...
.tag-select__sheet {
  ...
  background:
    radial-gradient(ellipse 80% 50% at 0% 0%, #ffe8c8 0%, transparent 55%),
    linear-gradient(180deg, #ffe4d8 0%, #ffffff 42%);
  box-shadow: 0 -12px 36px rgba(92, 46, 36, 0.16);
}
...
.tag-select__handle {
  ...
  border-radius: 999px;
  background: rgba(168, 107, 92, 0.3);
}
...
.tag-select__option {
  ...
  min-height: 48px;
  padding: 12px 14px;
  border: 1px solid rgba(240, 138, 107, 0.16);
  border-radius: 14px;
  ...
  &.active {
    ...
    background: linear-gradient(135deg, #ffb4a2, #f08a6b);
    color: #fff;
    box-shadow: 0 8px 18px rgba(240, 138, 107, 0.3);
  }
}
